...
Features:
- Sets up the conversationId with uuid to keep track of each chat session
...
- Also send the conversationId to the middleware server which adds it to the chat logs
